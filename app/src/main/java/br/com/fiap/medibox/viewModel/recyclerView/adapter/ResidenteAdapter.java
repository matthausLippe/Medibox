...
import br.com.fiap.medibox.viewModel.CadastroResidente;
...
import br.com.fiap.medibox.viewModel.recyclerView.viewHolder.ResidenteViewHolder;
        ...
        if (position == residentes.size()) {
            holder.adicionar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Fragment fragment = new CadastroResidente();
